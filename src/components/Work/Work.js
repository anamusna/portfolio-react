      ...
      if (id === repo.id) {
        this.setState(prevState => {
          return {
            ...
            {
              name: repo.name, repoURL: repo.html_url,
      ...
      <React.Fragment>
        <section className="work">
          ...
          <div className="work-text">
            <p>I built some SPA (Single Page Applications) using HTML5,CSS3, JS (ES6, ES7) with React or JQuery as front-end libraries and with Node.js and Express as back-end engine with MySQL or MongoDB for storing data.</p>
          </div>
